    ...
    var top_perth_schools = ["PERTH MODERN SCHOOL", "PRESBYTERIAN LADIES COLLEGE", "PENRHOS COLLEGE", "CHRIST CHURCH GRAMMAR SCHOOL", "SANTA MARIA COLLEGE",
      "ST HILDA'S ANGLICAN SCHOOL FOR GIRLS", "PERTH COLLEGE", "ST MARY'S ANGLICAN GIRLS' SCHOOL", "METHODIST LADIES' COLLEGE", "SHENTON COLLEGE"];
        ...
        function scatterChart(school) {
          ...
          houseData.forEach(data => {
            if (school == data.NEAREST_SCH){
              ...
              var dict = {x: data.NEAREST_SCH_DIST, y:Math.round(data.PRICE / data.LAND_AREA)};
              storage.push(dict);
            }
          });
