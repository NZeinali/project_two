...
//     var layout = {
//       title: `Land Size of properties sold in Perth from 1991 to 2020`,
//       xaxis: {
//         title: "Land Size (m2)",
//         dtick: 100,
//       },
...
//     var bedroom_arr = houseData.map((data) => data.Bedrooms);
...
//     Plotly.newPlot("hist_bedroom", data, layout);
...
//     // console.log(unique_suburbs);
//     // console.log(sum_price_unique_suburbs);
...
//     // console.log(sliced_suburb);
//     // console.log(sliced_price);
//     // console.log(sliced_price_per_land);
...
//         },
//       },
//       name: "Top 10 expensive suburbs based on their average sale price per land area",
//       orientation: "h",
//       transforms: [
//         {
//           type: "sort",
...
//         color: "rgb(128,0,128)",
//       },
//       name: "Average sales price of properties in the top 10 expensive suburbs",
//     };
...
// //     });
// //     console.log(houseData);
// //     var latitude_arr = houseData.map((data) => data.Latitude);
// //     var longitude_arr = houseData.map((data) => data.Longitude);
// //     var suburb_arr = houseData.map((data) => data.Suburb);
// //     var price_arr = houseData.map((data) => data.Price);
...
// //     var marker = L.marker([-32.02, 115.77], {
// //       draggable: true,
...
// //     // for (var i = 0; i < 100; i++) {
// //     //   var location = [latitude_arr[i], longitude_arr[i]];
// //     //   L.marker(location)
// //     //     .bindPopup(
// //     //       "<h1>" +
// //     //         suburb_arr[i] +
...
d3.json("/perthMarketjson")
  .then((houseData) => {
    ...
    //     houseData[i].Suburb,
    //     houseData[i].Price,
    //     houseData[i].Bedrooms,
    //     houseData[i].Land_Area,
    //     houseData[i].Build_Year,
    //     houseData[i].CBD_Dist,
    //     houseData[i].Nearest_STN,
    //     houseData[i].Nearest_STN_Dist,
    //     houseData[i].Latitude,
    //     houseData[i].Longitude,
    //     houseData[i].Nearest_SCH,
    //     houseData[i].Nearest_SCH_Dist,
    //     houseData[i].Year_Sold,
    //   ];
    //   // console.log(rowValue);
    //   rowValues.push(rowValue);
    //   // console.log(rowValues[i][1]);
    //   columnValue.push(rowValues[i]);
    // }
    ...
    //         "<b>CBD Distance</b>",
    //         "<b>Nearest Station</b>",
    //         "<b>Nearest Station Distance</b>",
    //         "<b>Latitude</b>",
    //         "<b>Longitude</b>",
    //         "<b>Nearest School</b>",
    //         "<b>Nearest School Distance</b>",
    //         "<b>Year Sold</b>",
    //       ],
    //       align: "center",
